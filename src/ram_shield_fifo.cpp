...
RamShield_fifo::RamShield_fifo(stats stat, size_t block_size):
	RamShield(stat, block_size)
{
}

RamShield_fifo::~RamShield_fifo() {}


size_t RamShield_fifo::proc(const Request* r, bool warmup) {
...
void RamShield_fifo::evict_item(RamShield::RItem& victimItem, bool warmup) {
